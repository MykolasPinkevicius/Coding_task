...
class PingPongTableTest {
    ...
    void isBallEscapedGivenCoordinateArgumentsShouldReturnTrue() {
        ...
        result = pingPongTable.isBallEscaped(xCoordinate,yCoordinate);
    ...
    void isBallBouncedToWallGivenCoordinateArgumentsShouldReturnTure() {
        ...
        result = pingPongTable.isBallBouncedToWall(xCoordinate, yCoordinate);
    ...
    void isBatBumpToWall() {
        ...
        result = pingPongTable.isBatBumpToWall(xCoordinate, yCoordinate);
